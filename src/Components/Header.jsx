...
const Header = forwardRef((props, ref) => {
  ...
  const getUser = async () => {
    ...
    if (category == "admin") setIsAdmin(true);
  };
  ...
  return (
    <>
      ...
      <nav className="header">
        ...
        <ul
          onClick={scroll}
          className={togglemenu ? "nav-links" : "toggle-links"}
          ref={toggleref}
        >
          <li>
        ...
        <div className="mobile-search" ref={menuRef}>
          <div className="search-field">
            <input
              type="text"
              className={`active-search-mobile ${searchActive ? "active" : ""}`}
              placeholder="I am looking for"
              value={inputVal}
              onChange={handelChange}
              onKeyDown={handleKeyDown}
            />
            <button
              className={`search-submit-mobile ${searchActive ? "active" : ""}`}
              onClick={handleSearchSubmit}
              type="submit"
            >
              <i class="fa-solid fa-magnifying-glass"></i>
        ...
        >
          {togglemenu ? (
            ...
            <div
              className="navbar-menu-btn active"
